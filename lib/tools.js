...
var ebml_tools_1 = require("./ebml-tools");
Object.defineProperty(exports, "readVint", { enumerable: true, get: function () { return ebml_tools_1.readVint; } });
Object.defineProperty(exports, "writeVint", { enumerable: true, get: function () { return ebml_tools_1.writeVint; } });
var ebml_tools_2 = require("./ebml-tools");
exports.ebmlBlock = _block;
function readBlock(buf) {
    return exports.ebmlBlock(new buffer_1.Buffer(buf));
}
...
function encodeTag(tagId, tagData, unknownSize) {
    ...
    return concat([
        ...
        unknownSize ?
            ...
            ebml_tools_2.writeVint(tagData.length),
        tagData
    ]);
}
...
function putRefinedMetaData(metadata, info) {
    ...
    var segmentSizeBuf = new buffer_1.Buffer('01ffffffffffffff', 'hex'); // Segmentの最後の位置は無数の Cluster 依存なので。 writeVint(newPayloadSize).byteLength ではなく、 infinity.
